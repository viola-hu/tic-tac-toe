...
const checkVertical = function(locationY){
...
const checkBackwardDiagonal = function (){
  ...
  if (matchingNumberBackwardDiagonal === boardLength){
    gameIsOver = true;
    return gameIsOver;
  }
};
...
const checkForwardDiagonal = function(){
  ...
  if (matchingNumberForwardDiagonal === boardLength){
    gameIsOver = true;
    return gameIsOver;
  }
};
